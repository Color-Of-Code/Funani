...
angular.module('signin', ['base64','ngRoute', 'restangular'])
...
.controller('SignInCtrl',['$scope','$http','$base64','$window','$location', 'Restangular'
    function($scope,$http,$base64,$window,$location, Restangular) {
